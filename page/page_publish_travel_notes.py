...
class PagePublish(Base):
    ...
    def page_click_add_travel_notes(self):
        self.base_click(page.click_add_travel_notes)
    ...
    def page_publish(self,name,title,content):
        ...
        sleep(1)
        if self.base_if_exist(page.click_add_travel_notes):
            self.page_click_add_travel_notes()
